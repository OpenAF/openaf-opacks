 ...
 * 
 * Copyright (c) 2022 Nuno Aguiar
 * Adapted for OpenAF
 * https://github.com/openaf/openaf-opacks/LICENCE
 */
...
var Figlet = (typeof exports !== "undefined" ? exports : window).Figlet = {
  ...
  loadFont: function(name, fn) {
    var path = getOPackPath("AsciiMo") || "."
    fn(io.readFileString(path + "/fonts.zip::" + fontPath + name + ".flf"))
    /*
